<template>
    <div>
        ...
        <div class="bg-theme-main text-white">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 60 1440 140" class="bg-theme-white">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 290" class="bg-theme-white">
